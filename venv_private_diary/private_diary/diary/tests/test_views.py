...
class TestDiaryDeleteView(LoggedInTestCase):
    ...
    def test_delete_diary_success(self):
        ...
        #日記削除処理の実行
        response = self.client.post(reverse_lazy('dairy:diary_delete', kwargs= {'pk':diary.pk}))
